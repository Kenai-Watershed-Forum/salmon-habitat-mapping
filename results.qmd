...
As of November 2023, a total length of **17.6 miles** of stream segments and **1152 lake acres** were included in the nominations.

The table below breaks down each nomination by length.
...
### sample events
tbl <- read_excel("input/2021_2023_stream_lengths.xlsx") %>%
  clean_names() %>%
